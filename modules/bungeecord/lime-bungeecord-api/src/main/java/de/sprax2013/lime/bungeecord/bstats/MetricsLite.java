package de.sprax2013.lime.bungeecord.bstats;
...
public class MetricsLite {
    static {
        ...
        String name = null, version = null, bStatsID = "";
        ...
        try {
            ...
            bStatsID = props.getProperty("bStatsID_Bungee", "");
        } catch (Exception ex) {
    ...
    // The plugin id
    private static final int pluginId;
